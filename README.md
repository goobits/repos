...
- Nested drift compares every discovered nested checkout that shares a normalized `origin`; `repos nested status --all` also lists unique and missing-origin copies and labels independent repositories, Git submodules, and linked worktrees separately.
